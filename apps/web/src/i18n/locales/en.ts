export default {
  translation: {
    ...
    errors: {
      ...
      nfce_timeout: 'The lookup took longer than expected. Try again.',
    ...
    nfce: {
      ...
      processing: 'Looking up the receipt… this can take up to a minute.',
    ...
    shopping: {
      ...
      noPriceYet: 'no price',
      itemsWithoutPrice: '{{count}} item without a price — tap it or import the receipt',
      itemsWithoutPrice_other: '{{count}} items without a price — tap them or import the receipt',
      actualQty: 'Quantity',
