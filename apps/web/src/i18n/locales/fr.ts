export default {
  translation: {
    ...
    forecast: {
      daysLeft_one: 'épuisé dans ~{{count}}j',
      daysLeft_other: 'épuisés dans ~{{count}}j',
      teaser: 'Prévision de réapprovisionnement — Pro',
    },
    nav: {
      home: 'Home',
      shop: 'Shop',
    ...
    priceInsights: {
      title: 'Achète maintenant ou attends',
      teaser: 'Achète maintenant ou attends — Pro',
      verdict: {
        buy: 'Bon moment : {{current}} est en dessous de la moyenne de {{avg}}.',
        wait: 'Mieux d\'attendre : {{current}} est au-dessus de la moyenne de {{avg}} et monte.',
        neutral: 'Prix stable près de la moyenne de {{avg}}.',
      },
      swap: '{{cheaper}} est {{pct}}% moins cher que {{pricier}} chez {{store}}.',
    },
    brands: {
      label: 'Brand',
      none: 'No brand',
    ...
    errors: {
      ...
      coupon_exhausted: 'Ce coupon est épuisé.',
      coupon_expired: 'Ce coupon a expiré.',
      coupon_already_redeemed: 'Cette maison a déjà utilisé ce coupon.',
      ...
      nfce_timeout: 'La consultation a pris plus de temps que prévu. Réessayez.',
    ...
    billing: {
      ...
      couponLabel: 'J\'ai un coupon',
      couponPlaceholder: 'Code coupon',
      couponRedeem: 'Utiliser le coupon',
      couponSuccess: 'Pro jusqu\'au {{date}}',
      ...
      forecastPaywallPitch: 'Sache quand chaque article s\'épuisera — la prévision de réapprovisionnement est réservée à Pro.',
      priceInsightsPaywallPitch: 'Découvre quand acheter et quelle marque est moins chère — les aperçus de prix sont réservés à Pro.',
    },
    nfce: {
      ...
      processing: 'Consultation du reçu sur le portail… cela peut prendre jusqu’à 1 min.',
    ...
    shopping: {
      ...
      priceOptional: 'facultatif',
      noPriceYet: 'sans prix',
      itemsWithoutPrice: '{{count}} article sans prix — touchez-le ou importez le reçu',
      itemsWithoutPrice_other: '{{count}} articles sans prix — touchez-les ou importez le reçu',
      actualQty: 'Quantity',
