...
| 5 | Billing | **Provedor: Mercado Pago** (cartão recorrente + Pix Automático, verificado). Scaffold ✅: limite de itens, filtro histórico 90d no free, CTA upgrade. Falta: credenciais MP pra checkout/preapproval/webhooks | Scaffold pronto · integração aguarda credenciais |
